...
<template>
    <div class="h-80 w-full flex flex-col justify-between rounded-xl max-w-xs mx-auto mb-8 border-red-200 border p-4">
        ...
        <div class="grid items-center w-full gap-4 text-white grid-cols-2 mb-4">
            <div class="flex flex-col space-y-1.5">
                ...
                <input id="ngn" v-model="ngnInitialAmount" class="bg-stone-900 border w-full p-2 rounded-md" type="number"/>
            </div>
            <div class="flex flex-col space-y-1.5">
                <label class="text-white" for="for">???</label>
                <input id="for" v-model="localizedAmount" class="bg-stone-900 border w-full p-2 rounded-md" type="number"/>
            </div>
        </div>
        ...
        <div class="flex items-center space-x-4 rounded-md border border-gray-500 p-4 w-full">
            ...
            <div class="flex-1 space-y-1">
                <p class="text-sm font-medium flex gap-1 items-center">1 Naira = ??? . ???</p>
            </div>
        </div>
    </div>
</template>
